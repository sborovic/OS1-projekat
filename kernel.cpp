...
int
userMain(int, char*[]); // Funkcija korisnickog programa
...
Kernel&
Kernel::getInstance(int argc, char* argv[])
{
...
int
Kernel::isLocked() const
{
  return locked != 0;
}

void
Kernel::updateRunning()
{
